...
INSTRUCTIONS = [
    ...
    # ========== COMPREESSAO DE LISTA ==========
    {"instruction": "escreva uma funcao que filtra numeros pares usando list comprehension",
     "output": "def filtrar_pares(lista):\n    return [x for x in lista if x % 2 == 0]"},
    {"instruction": "escreva uma funcao que eleva todos os numeros ao quadrado",
     "output": "def quadrados(lista):\n    return [x**2 for x in lista]"},
    {"instruction": "escreva uma funcao que extrai nomes de uma lista de dicionarios",
     "output": "def extrair_nomes(pessoas):\n    return [p['nome'] for p in pessoas]"},
    {"instruction": "escreva uma funcao que cria um dicionario com comprehension",
     "output": "def dicionario_quadrados(n):\n    return {x: x**2 for x in range(n)}"},
    {"instruction": "escreva uma funcao que acha numeros divisiveis por 3 e 5",
     "output": "def divisiveis_por_3_e_5(lista):\n    return [x for x in lista if x % 3 == 0 and x % 5 == 0]"},
    {"instruction": "escreva uma funcao que converte temperaturas usando map",
     "output": "def converter_para_fahrenheit(temperaturas_c):\n    return list(map(lambda c: (c * 9/5) + 32, temperaturas_c))"},
    {"instruction": "escreva uma funcao que usa filter para numeros positivos",
     "output": "def numeros_positivos(lista):\n    return list(filter(lambda x: x > 0, lista))"},

    # ========== MATRIZES ==========
    {"instruction": "escreva uma funcao que soma duas matrizes",
     "output": "def somar_matrizes(A, B):\n    return [[A[i][j] + B[i][j] for j in range(len(A[0]))] for i in range(len(A))]"},
    {"instruction": "escreva uma funcao que multiplica duas matrizes",
     "output": "def multiplicar_matrizes(A, B):\n    linhas_A, colunas_A = len(A), len(A[0])\n    colunas_B = len(B[0])\n    resultado = [[0] * colunas_B for _ in range(linhas_A)]\n    for i in range(linhas_A):\n        for j in range(colunas_B):\n            for k in range(colunas_A):\n                resultado[i][j] += A[i][k] * B[k][j]\n    return resultado"},
    {"instruction": "escreva uma funcao que transpoe uma matriz",
     "output": "def transpor(matriz):\n    return [[matriz[j][i] for j in range(len(matriz))] for i in range(len(matriz[0]))]"},
    {"instruction": "escreva uma funcao que calcula o determinante de matriz 2x2",
     "output": "def determinante2x2(matriz):\n    return matriz[0][0] * matriz[1][1] - matriz[0][1] * matriz[1][0]"},
    {"instruction": "escreva uma funcao que gera uma matriz identidade",
     "output": "def matriz_identidade(n):\n    return [[1 if i == j else 0 for j in range(n)] for i in range(n)]"},

    # ========== ALGORITMOS AVANCADOS ==========
    {"instruction": "escreva merge sort em python",
     "output": "def merge_sort(lista):\n    if len(lista) <= 1:\n        return lista\n    meio = len(lista) // 2\n    esq = merge_sort(lista[:meio])\n    dir = merge_sort(lista[meio:])\n    return _merge(esq, dir)\n\ndef _merge(esq, dir):\n    resultado = []\n    i = j = 0\n    while i < len(esq) and j < len(dir):\n        if esq[i] <= dir[j]:\n            resultado.append(esq[i])\n            i += 1\n        else:\n            resultado.append(dir[j])\n            j += 1\n    resultado.extend(esq[i:])\n    resultado.extend(dir[j:])\n    return resultado"},
    {"instruction": "escreva quick sort em python",
     "output": "def quick_sort(lista):\n    if len(lista) <= 1:\n        return lista\n    pivo = lista[len(lista) // 2]\n    menores = [x for x in lista if x < pivo]\n    iguais = [x for x in lista if x == pivo]\n    maiores = [x for x in lista if x > pivo]\n    return quick_sort(menores) + iguais + quick_sort(maiores)"},
    {"instruction": "escreva insertion sort em python",
     "output": "def insertion_sort(lista):\n    for i in range(1, len(lista)):\n        chave = lista[i]\n        j = i - 1\n        while j >= 0 and lista[j] > chave:\n            lista[j + 1] = lista[j]\n            j -= 1\n        lista[j + 1] = chave\n    return lista"},
    {"instruction": "escreva busca em largura (BFS) em python",
     "output": "from collections import deque\n\ndef bfs(grafo, inicio):\n    visitados = set()\n    fila = deque([inicio])\n    ordem = []\n    while fila:\n        vertice = fila.popleft()\n        if vertice not in visitados:\n            visitados.add(vertice)\n            ordem.append(vertice)\n            fila.extend(grafo.get(vertice, []))\n    return ordem"},
    {"instruction": "escreva busca em profundidade (DFS) em python",
     "output": "def dfs(grafo, inicio):\n    visitados = set()\n    ordem = []\n    def _dfs(v):\n        visitados.add(v)\n        ordem.append(v)\n        for vizinho in grafo.get(v, []):\n            if vizinho not in visitados:\n                _dfs(vizinho)\n    _dfs(inicio)\n    return ordem"},

    # ========== CONJUNTOS (SETS) ==========
    {"instruction": "escreva uma funcao que retorna a intersecao de duas listas",
     "output": "def intersecao(lista1, lista2):\n    return list(set(lista1) & set(lista2))"},
    {"instruction": "escreva uma funcao que retorna a uniao de duas listas",
     "output": "def uniao(lista1, lista2):\n    return list(set(lista1) | set(lista2))"},
    {"instruction": "escreva uma funcao que retorna a diferenca entre duas listas",
     "output": "def diferenca(lista1, lista2):\n    return list(set(lista1) - set(lista2))"},
    {"instruction": "escreva uma funcao que verifica se duas listas tem elementos em comum",
     "output": "def tem_elementos_comuns(lista1, lista2):\n    return bool(set(lista1) & set(lista2))"},

    # ========== TUPLAS ==========
    {"instruction": "escreva uma funcao que desempacota uma tupla",
     "output": "def desempacotar(tupla):\n    a, b, *resto = tupla\n    return a, b, resto"},
    {"instruction": "escreva uma funcao que converte lista de tuplas em dicionario",
     "output": "def tuplas_para_dicionario(lista_tuplas):\n    return dict(lista_tuplas)"},

    # ========== CONTEXT MANAGERS ==========
    {"instruction": "escreva um context manager que mede tempo",
     "output": "import time\nfrom contextlib import contextmanager\n\n@contextmanager\ndef medir_tempo(nome='bloco'):\n    inicio = time.time()\n    yield\n    fim = time.time()\n    print(f'{nome}: {fim-inicio:.4f}s')"},
    {"instruction": "escreva um context manager que abre e fecha arquivo",
     "output": "class ArquivoAberto:\n    def __init__(self, caminho, modo='r'):\n        self.caminho = caminho\n        self.modo = modo\n    def __enter__(self):\n        self.arquivo = open(self.caminho, self.modo, encoding='utf-8')\n        return self.arquivo\n    def __exit__(self, *args):\n        self.arquivo.close()"},

    # ========== PROPRIEDADES ==========
    {"instruction": "crie uma classe Pessoa com propriedade nome completo",
     "output": "class Pessoa:\n    def __init__(self, nome, sobrenome):\n        self._nome = nome\n        self._sobrenome = sobrenome\n    @property\n    def nome_completo(self):\n        return f'{self._nome} {self._sobrenome}'\n    @property\n    def iniciais(self):\n        return f'{self._nome[0]}.{self._sobrenome[0]}.'"},
    {"instruction": "crie uma classe Temperatura com propriedade em Celsius e Fahrenheit",
     "output": "class Temperatura:\n    def __init__(self, celsius=0):\n        self._celsius = celsius\n    @property\n    def celsius(self):\n        return self._celsius\n    @celsius.setter\n    def celsius(self, valor):\n        self._celsius = valor\n    @property\n    def fahrenheit(self):\n        return (self._celsius * 9/5) + 32"},

    # ========== EXCECOES ==========
    {"instruction": "escreva uma funcao que le um numero com tratamento de excecao",
     "output": "def ler_numero(mensagem='Digite um numero: '):\n    while True:\n        try:\n            return float(input(mensagem))\n        except ValueError:\n            print('Numero invalido. Tente novamente.')"},
    {"instruction": "escreva uma funcao que divide dois numeros com seguranca",
     "output": "def dividir_seguro(a, b):\n    try:\n        return a / b\n    except ZeroDivisionError:\n        return float('inf')"},
    {"instruction": "escreva uma funcao que cria uma excecao personalizada",
     "output": "class SaldoInsuficienteError(Exception):\n    def __init__(self, saldo, valor):\n        self.saldo = saldo\n        self.valor = valor\n        super().__init__(f'Saldo insuficiente: R$ {saldo:.2f} para saque de R$ {valor:.2f}')"},

    # ========== METODOS ESTATICOS / DE CLASSE ==========
    {"instruction": "crie uma classe Data com metodo estatico para formatar",
     "output": "class Data:\n    def __init__(self, dia, mes, ano):\n        self.dia = dia\n        self.mes = mes\n        self.ano = ano\n    @staticmethod\n    def formato_brasileiro(dia, mes, ano):\n        return f'{dia:02d}/{mes:02d}/{ano}'\n    @classmethod\n    def hoje(cls):\n        from datetime import date\n        d = date.today()\n        return cls(d.day, d.month, d.year)"},

    # ========== ORDENACAO PERSONALIZADA ==========
    {"instruction": "escreva uma funcao que ordena strings por tamanho",
     "output": "def ordenar_por_tamanho(lista):\n    return sorted(lista, key=len)"},
    {"instruction": "escreva uma funcao que ordena objetos por atributo",
     "output": "def ordenar_por_atributo(objetos, atributo):\n    return sorted(objetos, key=lambda x: getattr(x, atributo))"},
    {"instruction": "escreva uma funcao que encontra o elemento mais frequente",
     "output": "from collections import Counter\n\ndef elemento_mais_frequente(lista):\n    if not lista:\n        return None\n    return Counter(lista).most_common(1)[0][0]"},

    # ========== SISTEMAS DE ARQUIVOS ==========
    {"instruction": "escreva uma funcao que lista arquivos .py em um diretorio",
     "output": "import os\n\ndef listar_python(diretorio='.'):\n    return [f for f in os.listdir(diretorio) if f.endswith('.py')]"},
    {"instruction": "escreva uma funcao que calcula o tamanho total de um diretorio",
     "output": "import os\n\ndef tamanho_diretorio(caminho):\n    total = 0\n    for raiz, _, arquivos in os.walk(caminho):\n        for arquivo in arquivos:\n            total += os.path.getsize(os.path.join(raiz, arquivo))\n    return total"},

    # ========== MATEMATICA AVANCADA ==========
    {"instruction": "escreva uma funcao que calcula raiz quadrada pelo metodo de Newton",
     "output": "def raiz_quadrada(n, precisao=1e-10):\n    if n < 0:\n        raise ValueError('Numero negativo')\n    if n == 0:\n        return 0\n    x = n\n    while True:\n        raiz = (x + n / x) / 2\n        if abs(raiz - x) < precisao:\n            return raiz\n        x = raiz"},
    {"instruction": "escreva uma funcao que calcula logaritmo natural",
     "output": "import math\n\ndef log_natural(n):\n    return math.log(n) if n > 0 else float('-inf')"},
    {"instruction": "escreva uma funcao que verifica se um numero e quadrado perfeito",
     "output": "def quadrado_perfeito(n):\n    if n < 0:\n        return False\n    raiz = int(n ** 0.5)\n    return raiz * raiz == n"},
]
...
def main():
    ...
    print(f"Categorias: matematica, estatistica, listas, strings, ordenacao, OOP, "
          f"algoritmos, conversoes, validacao, dicionarios, arquivos, geradores, "
          f"decorators, recursao, utilitarios, compreensao_lista, matrizes, "
          f"algoritmos_avancados, conjuntos, tuplas, context_managers, "
          f"propriedades, excecoes, metodos_estaticos, ordenacao, sistemas_arquivos, "
          f"matematica_avancada")
